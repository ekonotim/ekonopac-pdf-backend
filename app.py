...
def generate_pdf():
    try:
        ...
        # Add side-by-side logos
        ekon_logo = Image("/mnt/data/EKON-LOGO-14.png", width=100, height=40)
        natureseal_logo = Image("/mnt/data/natureseal_logo.png", width=100, height=40)
        logo_table = Table([[ekon_logo, natureseal_logo]], colWidths=[250, 250])
